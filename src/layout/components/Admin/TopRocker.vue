                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <div class="row row-cols-3 g-3 p-3">
                                    <div class="col text-center">
                                        ...
                                        <div class="app-title">Bác sĩ</div>
                                    </div>
                                    <div class="col text-center">
                                        <div class="app-box mx-auto bg-gradient-burning text-white"><i
                                                class='bx bx-atom'></i>
                                        </div>
                                        <div class="app-title">Bệnh nhân</div>
                                    </div>
                                    <div class="col text-center">
                                        <div class="app-box mx-auto bg-gradient-lush text-white"><i
                                                class='bx bx-shield'></i>
                                        </div>
                                        <div class="app-title">Đặt lịch khám</div>
                                    </div>
                                    <div class="col text-center">
                                        <div class="app-box mx-auto bg-gradient-kyoto text-dark"><i
                                                class='bx bx-notification'></i>
                                        </div>
                                        <div class="app-title">Đơn thuốc</div>
                                    </div>
                                    <div class="col text-center">
                                    ...
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="msg-name">Khách hàng mới<span class="msg-time float-end">14
                                                        giây
                                                        trước</span></h6>
                                                <p class="msg-info">5 khách hàng đăng ký mới</p>
                                            </div>
                                        </div>
                                    </a>
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="msg-name">Đơn hàng mới<span class="msg-time float-end">2 phút
                                                        trước</span></h6>
                                                <p class="msg-info">Bạn đã nhận được đơn hàng mới</p>
                                            </div>
                                        </div>
                                    </a>
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="msg-name">24 PDF File<span class="msg-time float-end">19 phút
                                                        trước</span></h6>
                                                <p class="msg-info">Các tệp pdf đã được tạo</p>
                                            </div>
                                        </div>
                                    </a>
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="msg-name">Thời gian phản hồi <span class="msg-time float-end">28
                                                        phút
                                                        trước</span></h6>
                                                <p class="msg-info">5.1 phút trung bình thời gian phản hồi</p>
                                            </div>
                                        </div>
                                    </a>
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="msg-name">Sản phẩm mới đã được phê duyệt <span
                                                        class="msg-time float-end">2 giờ trước</span></h6>
                                                <p class="msg-info">Sản phẩm mới của bạn đã được phê duyệt</p>
                                            </div>
                                        </div>
                                    </a>
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="msg-name">Bình luận mới<span class="msg-time float-end">4 giờ
                                                        trước</span></h6>
                                                <p class="msg-info">Bình luận mới từ khách hàng</p>
                                            </div>
                                        </div>
                                    </a>
                                    <a class="dropdown-item" href="javascript:;">
                ...
                <div class="user-box dropdown">
                    <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                        ...
                        <div class="user-info ps-3">
                            <p class="user-name mb-0">Nguyễn Văn A</p>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item" href="javascript:;"><i
                                    class='bx bx-home-circle'></i><span>Đăng xuất</span></a>
                        </li>
                        <li>
