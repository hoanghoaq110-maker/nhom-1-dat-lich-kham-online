        ...
        <div class="container py-3">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-3 col-6">
                    <div class="mb-4">
                        <h5 class="fw-bold mb-4 text-info border-bottom border-info border-2 pb-2 d-inline-block">Dịch vụ</h5>
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-3">
                                <a href="#" class="text-light text-decoration-none d-flex align-items-center py-1 px-2 rounded">
                                    <i class="fa-solid fa-user-doctor me-2 text-info"></i>
                                    Phẫu thuật
                                </a>
                            </li>
                            <li class="mb-3">
                ...
                <div class="col-lg-2 col-md-3 col-6">
                    <div class="mb-4">
                        <h5 class="fw-bold mb-4 text-info border-bottom border-info border-2 pb-2 d-inline-block">Chuyên khoa</h5>
                        <ul class="list-unstyled">
                            <li class="mb-3">
                                <a href="#" class="text-light text-decoration-none d-flex align-items-center py-1 px-2 rounded">
