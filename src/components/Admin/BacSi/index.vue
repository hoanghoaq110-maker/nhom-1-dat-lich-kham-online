                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <label>Họ Tên</label>
                            <input type="text" class="form-control" v-model="create_bac_si.ho_ten">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label>Email</label>
                            <input type="email" class="form-control" v-model="create_bac_si.email">
                        </div>
                       
                        <div class="col-md-6 mb-2">
                            <label>Số Điện Thoại</label>
                            <input type="number" class="form-control" v-model="create_bac_si.so_dien_thoai">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label>Ngày sinh</label>
                            <input type="date" class="form-control" v-model="create_bac_si.ngay_sinh">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label>Giới Tính</label>
                            <select class="form-select" v-model.number="create_bac_si.gioi_tinh">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <select class="form-select" v-model="create_bac_si.id_phong_kham">
                                ...
                                <option v-for="p in list_phong_kham" :key="p.id" :value="p.id">{{ p.ten_phong_kham || p.name || p.id }}</option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-2">
                            <label>Chuyên Khoa</label>
                            <select class="form-select" multiple v-model="create_bac_si.chuyen_khoa">
                               <option v-for="ck in list_chuyen_khoa" :key="ck.id" :value="ck.id">{{ ck.ten_chuyen_khoa || ck.name || ck.id }}</option>
                            </select>
                            <small class="text-muted">Giữ phím Ctrl (Windows) hoặc Command (Mac) để chọn nhiều chuyên ngành</small>
                        </div>
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <select class="form-select" v-model="create_bac_si.tinh_trang">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <label>Họ Tên</label>
                            <input type="text" class="form-control" v-model="update_bac_si.ho_ten">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label>Email</label>
                            <input type="email" class="form-control" v-model="update_bac_si.email">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label>Số Điện Thoại</label>
                            <input type="text" class="form-control" v-model="update_bac_si.so_dien_thoai">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label>Ngày sinh</label>
                            <input type="date" class="form-control" v-model="update_bac_si.ngay_sinh">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label>Giới Tính</label>
                            <select class="form-select" v-model="update_bac_si.gioi_tinh">
                                <option :value="1">Nam</option>
                                <option :value="0">Nữ</option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-2">
                            <label>Phòng Khám</label>
                            <select class="form-select" v-model="update_bac_si.id_phong_kham">
                                <option value="">-- Chọn phòng khám --</option>
                        ...
                        <div class="col-md-6 mb-2">
                            <label>Tình Trạng</label>
                            <select class="form-select" v-model.number="update_bac_si.tinh_trang">
                                <option :value="1">Hoạt Động</option>
                                <option :value="0">Tạm Tắt</option>
                            </select>
                        </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12 text-center mb-4">
                            <img :src="view_bac_si.hinh_anh || '/path/to/default-avatar.png'"
                                 class="rounded-circle border border-3 border-primary mb-3" 
                                 width="150" height="150">
                            <h4 class="mb-1">{{ view_bac_si.ho_ten || '-' }}</h4>
                            <p class="text-muted mb-2">
                                {{ view_bac_si.ten_chuyen_khoa || '-' }}
                            </p>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <span>{{ view_bac_si.gioi_tinh === 1 ? 'Nam' : (view_bac_si.gioi_tinh === 0 ? 'Nữ' : '-') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <p class="mb-0">{{ view_bac_si.ten_chuyen_khoa || '-' }}</p>
                                    </div>
                                    <div class="mb-3">
                                        <h6 class="text-primary mb-2">Mô Tả</h6>
                                        <p class="mb-0">{{ view_bac_si.mo_ta || '-' }}</p>
                                    </div>
                                    <div class="mb-3">
